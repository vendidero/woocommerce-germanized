...
;(function ( $, window, document, undefined ) {
    ...
    GermanizedVariationForm.prototype.getPriceElement = function( self ) {
         ...
         */
        return $wrapper.find( wc_gzd_add_to_cart_variation_params.price_selector + ':not(.price-unit):visible' ).not( wc_gzd_add_to_cart_variation_params.ignore_price_selector ).first();
    };
