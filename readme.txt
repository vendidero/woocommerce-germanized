...
* New: [Withdrawal button] Withdrawal preview modal
* Improvement: [Withdrawal button] Link withdrawal items with refunds to prevent reducing withdrawable quantity twice
* Fix: [Withdrawal button] Edge-case where edit withdrawal guest links where missing the current order
...
* New: [Withdrawal button] Store withdrawals as custom order type
* New: [Withdrawal button] Allow choosing a different support email via setting
* Improvement: Variable bundle price labels
* Improvement: Unit price observation for FSE themes
* Fix: Prevent rescheduling shiptastic install notice after 4.X
* Fix: Bump terms.php template version

= 4.0.3 =
* Fix: [Withdrawal button] Prevent calling customer in admin context

= 4.0.2 =
* Improvement: [Withdrawal button] Allow withdrawal requests without order number and differing email address
* Improvement: [Withdrawal button] Mark withdrawal requests as verified/unverified based on email address
* Improvement: [Withdrawal button] Separately list unverified withdrawal requests by default
* Improvement: [Withdrawal button] Allow verified guests to choose another order in case multiple orders are withdrawable
* Improvement: [Withdrawal button] Allow choosing first + last name
...
* Improvement: Elementor Pro checkout widget detection and compatibility
* Improvement: Do not use deprecated wc_enqueue_js
...
* Improvement: Show inline checkbox error messages, if available, within block-based checkout
* Improvement: Interpret additional costs for newly created orders via REST as net
* Improvement: Removed the built-in language fallback for de_CH and de_AT as it doesn't work in newer WP env - install language fallback plugin instead
