...
<div class="legal-price-info">
	<p class="wc-gzd-additional-info">
		...
		<?php elseif ( get_option( 'woocommerce_gzd_small_enterprise' ) == 'yes' && get_option( 'woocommerce_gzd_display_product_detail_tax_info' ) == 'yes' ) : ?>
			<span class="wc-gzd-additional-info small-business-info"><?php _e( 'incl. VAT', 'woocommerce-germanized' );?></span>
		<?php endif; ?>
