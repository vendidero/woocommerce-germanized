...
?>
<?php if ( wc_gzd_is_legal_guarantee_enabled() && apply_filters( 'woocommerce_gzd_show_global_legal_guarantee_notice', ( in_array( $location, array( 'checkout', 'cart' ), true ) ? wc_gzd_cart_needs_legal_guarantee() : true ), $location ) ) : ?>
