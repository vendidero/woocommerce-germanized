...
<p><?php printf( _x( 'Dear %s %s,', 'ekomi', 'woocommerce-germanized' ), $order->get_billing_first_name(), $order->get_billing_last_name() ); ?></p>
...
<table cellspacing="0" cellpadding="0" style="width: 100%; border: none;" border="0">
	<tr align="center">
		<td align="center"><a class="wc-button button" href="<?php echo esc_url( $order->get_meta('_ekomi_review_link' ) ); ?>" target="_blank"><?php echo _x( 'Rate Order now', 'ekomi', 'woocommerce-germanized' );?></a></td>
	</tr>
</table>
