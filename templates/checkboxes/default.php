...
<p class="<?php $checkbox->render_classes( $checkbox->get_html_wrapper_classes() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped; ?>" style="<?php echo esc_attr( $checkbox->get_html_style() ); ?>">
