	...
	public function get_tab_settings( $current_section = '' ) {
		return array(
			...
			array(
				...
				'desc' 		=> __( 'Enable customer double opt in during registration.', 'woocommerce-germanized' ),
			...
			array(
				...
				'type' 		=> 'number',
				'css'       => 'width: 80px;',
				'custom_attributes' => array( 'min' => 0, 'step' => 1, 'data-show_if_woocommerce_gzd_customer_activation' => '' ),
				'default'	=> 7,
			),
