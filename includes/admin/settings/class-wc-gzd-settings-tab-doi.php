	...
	public function get_tab_settings( $current_section = '' ) {
		return array(
			...
			array(
				...
				'desc'              => __( 'Disable login for unactivated customers.', 'woocommerce-germanized' ),
				'desc_tip'          => __( 'Customers that did not click on the activation link will not be able to login to their account.', 'woocommerce-germanized' ),
