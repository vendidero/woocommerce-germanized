...
<div class="error fade">
	...
	<p><?php printf( __( 'It seems like your theme is not yet ready for Germanized. Please check your theme\'s styles. Some things might look weird - Germanized can only offer basic styles. See <a href="%s" target="_blank">making your theme compatible</a> or check out our Theme <a href="%s" target="_blank">VendiPro</a> for 100&#37; compatibility.', 'woocommerce-germanized' ), 'https://vendidero.de/dokument/woocommerce-germanized-theme-kompatibilitaet?theme=' . esc_attr( $current_theme->get( 'Name' ) ), 'https://vendidero.de/vendipro' ); ?></p>
