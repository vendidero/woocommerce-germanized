...
<div id="message" class="error fade woocommerce-gzd-message">
	<a class="notice-dismiss" href="<?php echo esc_url( $dismiss_url ); ?>"><?php esc_html_e( 'Dismiss', 'woocommerce-germanized' ); ?></a>
	...
	<p class="submit">
		<a class="button-primary" href="<?php echo esc_url( admin_url( 'admin.php?page=wc-status&tab=germanized' ) ); ?>" target="_blank"><?php esc_html_e( 'View affected templates', 'woocommerce-germanized' ); ?></a>
	</p>
</div>