...
<div id="message" class="updated woocommerce-message woocommerce-gzd-message wc-connect">
	...
	<p><?php _e( 'It seems like as if you already had a german market extension for WooCommerce installed. Do you want to import some data? This may take a while depending on the number of products.', 'woocommerce-germanized' ); ?></p>
	<p class="submit">
