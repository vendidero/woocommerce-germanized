...
<div class="wc-gzd-setup-grid">
	<div class="wc-gzd-setup-grid-item">
		...
		<ul class="more">
			<li><i class="dashicons dashicons-book"></i> <a href="https://vendidero.de/dokumentation/woocommerce-germanized" target="_blank"><?php _e( 'Knowledge Base', 'woocommerce-germanized' ); ?></a></li>
			<li><i class="dashicons dashicons-calendar-alt"></i> <a href="https://vendidero.de/blog" target="_blank"><?php _e( 'Stay tuned', 'woocommerce-germanized' ); ?></a></li>
			<li><i class="dashicons dashicons-welcome-learn-more"></i> <a href="https://wordpress.org/support/" target="_blank"><?php _e( 'Learn how to use WordPress', 'woocommerce-germanized' ); ?></a></li>
