...
wp i18n make-pot --ignore-domain ./packages/eu-order-withdrawal-button-for-woocommerce ./packages/eu-order-withdrawal-button-for-woocommerce/i18n/eu-order-withdrawal-button-for-woocommerce.pot --exclude="assets/,.github,release/,lib/"

output 3 "Update i18n script paths in POT file to make sure WP is able to load the right translations from packages dir"
sed -i '' -e "s/\#: build\//\#: packages\/eu-order-withdrawal-button-for-woocommerce\/build\//g" ./packages/eu-order-withdrawal-button-for-woocommerce/i18n/eu-order-withdrawal-button-for-woocommerce.pot
output 2 "Done"

# Create Germanized Pro POT file and merge with StoreaBill
wp i18n make-pot ./ ./i18n/languages/woocommerce-germanized.pot --ignore-domain --exclude="assets/,release/,lib/" --merge="./packages/eu-order-withdrawal-button-for-woocommerce/i18n/eu-order-withdrawal-button-for-woocommerce.pot"
