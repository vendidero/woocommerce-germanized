...
class WC_Trusted_Shops_Review_Exporter extends WC_CSV_Exporter {
	...
	public function get_default_column_names() {
		return apply_filters(
			"woocommerce_gzd_{$this->export_type}_default_columns",
			array(
				'id'                 => 'reference',
				'date'               => 'date',
				'days'               => 'days',
	...
	public function prepare_data_to_export() {
		...
		$date    = date( 'Y-m-d', strtotime( '-' . $this->get_interval_days() . ' days' ) ); // phpcs:ignore WordPress.DateTime.RestrictedFunctions.date_date
		$args    = array(
