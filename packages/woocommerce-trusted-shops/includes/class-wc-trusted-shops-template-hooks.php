			...
			if ( ! empty( $code ) && ! empty( $order_id ) ) {
				...
				while ( $order_query->have_posts() ) {
					...
					if ( $order ) {
						...
						wp_die( wp_kses_post( sprintf( _x( 'Your review reminder e-mail has been cancelled successfully. Return to %s.', 'trusted-shops', 'woocommerce-germanized' ), '<a href="' . esc_url( get_site_url() ) . '">' . esc_html_x( 'Home', 'trusted-shops', 'woocommerce-germanized' ) . '</a>' ) ) );
					}
				}
			}
		}
