...
class WC_Trusted_Shops_Admin {
	...
	public function output_variation_fields( $loop, $variation_data, $variation ) {
		...
		<div class="variable_gzd_ts_labels">
			<p class="form-row form-row-first">
				<label for="variable_ts_gtin"><?php echo esc_html_x( 'GTIN', 'trusted-shops', 'woocommerce-germanized' ); ?> <?php echo wc_ts_help_tip( _x( 'ID that allows your products to be identified worldwide. If you want to display your Trusted Shops Product Reviews in Google Shopping and paid Google adverts, Google needs the GTIN.', 'trusted-shops', 'woocommerce-germanized' ) ); ?></label>
			...
			<p class="form-row form-row-last">
				<label for="variable_ts_mpn"><?php echo esc_html_x( 'MPN', 'trusted-shops', 'woocommerce-germanized' ); ?> <?php echo wc_ts_help_tip( _x( 'If you don\'t have a GTIN for your products, you can pass the brand name and the MPN on to Google to use the Trusted Shops Google Integration.', 'trusted-shops', 'woocommerce-germanized' ) ); ?></label>
		...
		$settings = array(
			...
			array(
				...
				'custom_attributes' => array(
					...
					'max'               => 5,
					'data-validate'     => 'integer',
					'data-validate-msg' => sprintf( _x( 'Please choose a non-negative number between %1$d and %2$d', 'trusted-shops', 'woocommerce-germanized' ), 1, 5 ),
				),
				'css'               => 'max-width:60px;',
			),
		...
		<div class="wc-gzd-admin-settings-sidebar-inner sticky">
			<div class="wc-gzd-admin-settings-sidebar-trusted-shops">
				<div class="wc-ts-sidebar wc-ts-sidebar-active" id="wc-ts-sidebar-default">
					<h3><?php echo esc_html_x( 'How does Trusted Shops make your shop better?', 'trusted-shops', 'woocommerce-germanized' ); ?></h3>
					...
					<a class="button button-primary" href="<?php echo esc_url( $this->get_signup_url() ); ?>" target="_blank"><?php echo esc_html_x( 'Get your account', 'trusted-shops', 'woocommerce-germanized' ); ?></a>
				</div>
				...
				<div class="wc-ts-sidebar wc-ts-sidebar-flex" id="wc-ts-sidebar-trustbadge">
					<div class="wc-ts-sidebar-left wc-ts-sidebar-container">
						...
						<span class="wc-ts-sidebar-desc"><?php echo esc_html_x( 'Display Trustbadge with review stars', 'trusted-shops', 'woocommerce-germanized' ); ?></span>
					</div>
					<div class="wc-ts-sidebar-right wc-ts-sidebar-container">
						...
						<span class="wc-ts-sidebar-desc"><?php echo esc_html_x( 'Display Trustbadge without review stars', 'trusted-shops', 'woocommerce-germanized' ); ?></span>
					</div>
				</div>
				...
				<div class="wc-ts-sidebar" id="wc-ts-sidebar-product-reviews">
					...
					<span class="wc-ts-sidebar-desc"><?php echo esc_html_x( 'Product Reviews on the product detail page in an additional tab', 'trusted-shops', 'woocommerce-germanized' ); ?></span>

					<img style="width: 100%; height: auto" src="<?php echo esc_url( $this->get_image( 'ts_woo.jpg' ) ); ?>" />
					<span class="wc-ts-sidebar-desc"><?php echo esc_html_x( 'Show Star-Ratings on the product detail page below your product name', 'trusted-shops', 'woocommerce-germanized' ); ?></span>
				</div>
				...
				<div class="wc-ts-sidebar" id="wc-ts-sidebar-review-reminder">
					...
					<a class="button button-secondary" href="<?php echo esc_url( $this->get_trusted_url( 'https://www.trustedshops.com/tsb2b/sa/ratings/shopRatingWidgetSettings.seam' ) ); ?>" target="_blank"><?php echo esc_html_x( 'To your My Trusted Shops account', 'trusted-shops', 'woocommerce-germanized' ); ?></a>
				</div>

				<div class="wc-ts-sidebar" id="wc-ts-sidebar-review-collector">
					<p><?php echo esc_html_x( 'Export your customer information here and upload it in the Trusted Shops Review Collector. To do so go to your My Trusted Shops account. Log in and go to Reviews > Shop Reviews > Review Collector', 'trusted-shops', 'woocommerce-germanized' ); ?></p>
					<a class="button button-secondary" href="<?php echo esc_url( $this->get_trusted_url( 'https://www.trustedshops.com/tsb2b/sa/ratings/reviewCollector/reviewCollector.seam' ) ); ?>" target="_blank"><?php echo esc_html_x( 'To the Trusted Shops Review Collector', 'trusted-shops', 'woocommerce-germanized' ); ?></a>
				</div>
			</div>
		</div>
		<?php
	...
	public function review_collector_export() {
		...
		?>
		<h2><?php echo esc_html_x( 'Review Collector', 'trusted-shops', 'woocommerce-germanized' ); ?></h2>
		<div id="trusted_shops_review_collector_options-description">
			<p class="description"><?php echo wp_kses_post( sprintf( _x( 'Want to collect reviews for orders that were placed before your Trusted Shops Integration? No problem. Export old orders here and upload them in your %s.', 'trusted-shops', 'woocommerce-germanized' ), '<a href="' . esc_url( $this->get_trusted_url( 'https://www.trustedshops.com/tsb2b/sa/ratings/reviewCollector/reviewCollector.seam' ) ) . '" target="_blank">' . esc_html_x( 'My Trusted Shops account', 'trusted-shops', 'woocommerce-germanized' ) . '</a>' ) ); ?></p>
		</div>
		<table class="form-table">
			<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="woocommerce_gzd_trusted_shops_review_collector"><?php echo esc_html_x( 'Export orders', 'trusted-shops', 'woocommerce-germanized' ); ?> <?php echo wc_ts_help_tip( _x( 'Export your customer and order information of the last x days and upload them in your My Trusted Shops Account.', 'trusted-shops', 'woocommerce-germanized' ) ); ?></label>
				</th>
				<td class="forminp forminp-select forminp-review-collector">
					<select data-sidebar="wc-ts-sidebar-review-collector" name="woocommerce_<?php echo esc_attr( $this->base->option_prefix ); ?>trusted_shops_review_collector" id="woocommerce_<?php echo esc_attr( $this->base->option_prefix ); ?>trusted_shops_review_collector" class="chosen_select">
						<option value="30" <?php selected( 30, $days_interval ); ?>><?php echo esc_html_x( '30 days', 'trusted-shops', 'woocommerce-germanized' ); ?></option>
						<option value="60" <?php selected( 60, $days_interval ); ?>><?php echo esc_html_x( '60 days', 'trusted-shops', 'woocommerce-germanized' ); ?></option>
						<option value="90" <?php selected( 90, $days_interval ); ?>><?php echo esc_html_x( '90 days', 'trusted-shops', 'woocommerce-germanized' ); ?></option>
					</select>
					<span class="description"><?php echo wp_kses_post( sprintf( _x( 'Upload customer and order information %s.', 'trusted-shops', 'woocommerce-germanized' ), '<a href="' . esc_url( $this->get_trusted_url( 'https://www.trustedshops.com/tsb2b/sa/ratings/reviewCollector/reviewCollector.seam' ) ) . '" target="_blank">' . esc_html_x( 'here', 'trusted-shops', 'woocommerce-germanized' ) . '</a>' ) ); ?></span>
					<div class="trusted-shops-review-collector-wrap">
						<div class="review-collector-days">
							<label for="woocommerce_gzd_trusted_shops_review_collector"><?php echo esc_html_x( 'Days until reminder mail', 'trusted-shops', 'woocommerce-germanized' ); ?> <?php echo wc_ts_help_tip( _x( 'Set the number of days to wait after the order date before having a Review Request sent to your customers.', 'trusted-shops', 'woocommerce-germanized' ) ); ?></label>
						...
						<div class="review-collector-buttons">
							<a class="button button-secondary" id="wc-gzd-trusted-shops-export" data-href-org="<?php echo esc_url( $href_org ); ?>" href="#"><?php echo esc_html_x( 'Start export', 'trusted-shops', 'woocommerce-germanized' ); ?></a>
						</div>
					</div>
				</td>
			</tr>
