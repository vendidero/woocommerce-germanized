...
<div id="message" class="updated woocommerce-message woocommerce-gzd-message wc-connect">
	<p><?php echo wp_kses_post( _x( '<strong>WooCommerce Trusted Shops Data Update Required</strong> &#8211; We just need to update your installation to the latest version', 'trusted-shops', 'woocommerce-germanized' ) ); ?></p>
