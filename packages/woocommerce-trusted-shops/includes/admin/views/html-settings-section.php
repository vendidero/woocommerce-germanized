...
?>
<div class="wc-gzd-admin-settings wc-ts-admin-settings <?php echo ( ! empty( $sidebar ) ? 'wc-gzd-admin-settings-has-sidebar' : '' ); ?> wc-gzd-admin-settings-trusted_shops <?php echo ( ! empty( $current_section ) ? 'wc-gzd-admin-settings-trusted-shops-' . esc_attr( $current_section ) : '' ); ?>">
