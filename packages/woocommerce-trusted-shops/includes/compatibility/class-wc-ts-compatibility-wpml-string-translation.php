...
class WC_TS_Compatibility_Wpml_String_Translation extends WC_TS_Compatibility {
	...
	public function get_string_language( $string_id, $option = '' ) {
		...
		global $WPML_String_Translation; // phpcs:ignore WordPress.NamingConventions.ValidVariableName.VariableNotSnakeCase

		return $WPML_String_Translation->get_current_string_language( $option ); // phpcs:ignore WordPress.NamingConventions.ValidVariableName.VariableNotSnakeCase
	}
