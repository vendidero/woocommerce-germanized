	...
	protected function get_packing_settings() {
		return array(
			...
			array(
				...
				'desc'    => _x( 'Automatically pack orders based on available packaging options', 'shipments', 'woocommerce-germanized' ) . '<div class="wc-gzd-shipments-additional-desc">' . sprintf( _x( 'By enabling this option, shipments will be packed based on your available packaging options. For that purpose a knapsack algorithm is used to best fit available order items within your packaging. <a href="%s" target="_blank">Learn more</a> about the feature.', 'shipments', 'woocommerce-germanized' ), 'https://vendidero.de/dokument/sendungen-automatisiert-packen' ) . '</div>',
			...
			array(
				...
				'desc'              => _x( 'Group items by shipping class.', 'shipments', 'woocommerce-germanized' ) . '<div class="wc-gzd-shipments-additional-desc">' . sprintf( _x( 'Use this option to prevent items with different shipping classes from being packed in the same package.', 'shipments', 'woocommerce-germanized' ) ) . '</div>',
			...
			array(
				...
				'desc'              => '<div class="wc-gzd-shipments-additional-desc">' . sprintf( _x( 'Choose a buffer type to leave space between the items and outer dimensions of your packaging.', 'shipments', 'woocommerce-germanized' ) ) . '</div>',
