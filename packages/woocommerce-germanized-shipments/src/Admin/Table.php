...
class Table extends WP_List_Table {
	...
	public function column_title( $shipment ) {
		...
		echo '<a href="#" class="shipment-preview has-shipment-modal" data-id="wc-gzd-modal-preview-shipment" data-load-async="1" data-reference="' . esc_attr( $shipment->get_id() ) . '" data-nonce-params="wc_gzd_admin_shipments_table_params">' . esc_html_x( 'Preview', 'shipments', 'woocommerce-germanized' ) . '</a>';
