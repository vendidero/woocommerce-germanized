				...
				<article>
					<form id="wc-gzd-shipments-pickup-location-search-form" method="post">
						<div class="pickup-location-search-fields-wrapper">
							...
							<button type="submit" class="button <?php echo esc_attr( wc_gzd_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_gzd_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" id="wc-gzd-shipments-search-pickup-location-submit" aria-label="<?php echo esc_html_x( 'Search', 'shipments', 'woocommerce-germanized' ); ?>"><?php echo esc_html_x( 'Search', 'shipments', 'woocommerce-germanized' ); ?></button>
						</div>
		...
		<div class="form-row form-row-wide pickup_location_notice <?php echo esc_attr( $args['hidden'] ? 'hidden' : '' ); ?>" id="<?php echo esc_attr( $args['id'] ); ?>" data-priority="<?php echo esc_attr( $args['priority'] ); ?>">
			<div class="choose-pickup-location" <?php echo ( $args['current_location'] ? 'style="display: none;"' : '' ); ?>>
				<p>
					...
					<a href="#" class="pickup-location-notice-link wc-gzd-modal-launcher" data-modal-id="pickup-location" aria-label="<?php echo esc_html_x( 'Choose a pickup location', 'shipments', 'woocommerce-germanized' ); ?>" role="button"><?php echo esc_html_x( 'Choose a pickup location', 'shipments', 'woocommerce-germanized' ); ?></a>
