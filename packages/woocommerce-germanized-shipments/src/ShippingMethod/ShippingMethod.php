...
class ShippingMethod extends \WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0, $shipping_provider = null ) {
		...
		$this->method_description = sprintf( _x( 'Apply rule-based shipping costs for shipments handled by %1$s based on your available packaging options. Learn <a href="%2$s">how to configure →</a>', 'shipments', 'woocommerce-germanized' ), $this->shipping_provider->get_title(), 'https://vendidero.de/dokument/versandregeln-erstellen' );
		...
		return apply_filters(
			...
			array(
				...
				'package_shipping_classes' => array(
					'label'     => _x( 'Shipping Class', 'shipments', 'woocommerce-germanized' ),
					'fields'    => array(
						'classes' => array(
							'type'      => 'multiselect',
							'data_type' => 'array',
			...
			<tfoot>
				<tr>
					<th colspan="7">
						...
						<a class="button button-primary wc-gzd-shipments-shipping-rule-add" href="#"><?php echo esc_html_x( 'Add new', 'shipments', 'woocommerce-germanized' ); ?></a>
						<a class="button button-secondary wc-gzd-shipments-shipping-rule-remove disabled" href="#"><?php echo esc_html_x( 'Remove selected', 'shipments', 'woocommerce-germanized' ); ?></a>
					</th>
				</tr>
			</tfoot>
		</table>
