	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
        error_log(  // phpcs:ignore
			...
			/* translators: 1: composer command. 2: plugin directory */
				esc_html_x( 'Your installation of the Germanized Shipments feature plugin is incomplete. Please run %1$s within the %2$s directory.', 'shipments', 'woocommerce-germanized' ),
				'`composer install`',
