...
if ( ! class_exists( 'WC_GZD_Email_Customer_Shipment', false ) ) :
    ...
    class WC_GZD_Email_Customer_Shipment extends WC_Email {
        ...
        public function init_form_fields() {
	        ...
	        $placeholder_text  = sprintf( __( 'Available placeholders: %s', 'shipments', 'woocommerce-germanized' ), '<code>' . esc_html( implode( '</code>, <code>', array_keys( $this->placeholders ) ) ) . '</code>' );
