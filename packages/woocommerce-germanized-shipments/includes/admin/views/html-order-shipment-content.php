...
<div class="shipment-content">
    <div class="columns">
        ...
        <div class="column col-6">
            <p class="form-row">
                <label for="shipment-weight-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php printf( _x( 'Weight (%s)', 'shipments', 'woocommerce-germanized' ), get_option( 'woocommerce_weight_unit' ) ); ?></label>
            ...
            <p class="form-row dimensions_field">
                <label for="shipment-length-<?php echo esc_attr( $shipment->get_id() ); ?>"><?php printf( _x( 'Dimensions (%s)', 'shipments', 'woocommerce-germanized' ), get_option( 'woocommerce_dimension_unit' ) ); ?><?php echo wc_help_tip( _x( 'LxWxH in decimal form.', 'shipments', 'woocommerce-germanized' ) ); ?></label>
