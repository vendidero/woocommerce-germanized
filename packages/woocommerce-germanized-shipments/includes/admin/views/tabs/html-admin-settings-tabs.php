...
<table class="wc-gzd-shipments-setting-tabs widefat">
	<thead>
	<tr>
		<th class="wc-gzd-shipments-setting-tab-name"><?php echo esc_html_x( 'Name', 'shipments', 'woocommerce-germanized' ); ?></th>
		<th class="wc-gzd-shipments-setting-tab-enabled"><?php echo esc_html_x( 'Enabled', 'shipments', 'woocommerce-germanized' ); ?></th>
		<th class="wc-gzd-shipments-setting-tab-desc"><?php echo esc_html_x( 'Description', 'shipments', 'woocommerce-germanized' ); ?></th>
			...
			<td class="wc-gzd-shipments-setting-tab-enabled" id="wc-gzd-shipments-setting-tab-enabled-<?php echo esc_attr( $tab->get_name() ); ?>">
				<?php if ( $tab->needs_install() ) : ?>
					<?php if ( current_user_can( 'install_plugins' ) ) : ?>
						<a class="button button-secondary wc-gzd-shipments-install-extension-btn wc-gzd-ajax-loading-btn" data-extension="<?php echo esc_attr( $tab->get_extension_name() ); ?>" href="<?php echo esc_url( $tab->get_url() ); ?>"><span class="btn-text"><?php echo esc_html_x( 'Install', 'shipments', 'woocommerce-germanized' ); ?></span></a>
					<?php else : ?>
