...
<tr>
	<td>
		<select id="wc-gzd-shipment-add-items-select" name="item_id">
	...
	<td>
		<input id="wc-gzd-shipment-add-items-quantity" type="number" step="1" min="0" max="9999" autocomplete="off" name="item_qty" placeholder="1" size="4" value="1" class="quantity" />
	</td>
</tr>
</tbody>
