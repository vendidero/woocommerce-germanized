...
class PreferredNeighbour extends Service {
	...
	public function __construct( $shipping_provider, $args = array() ) {
		$args = array(
			...
			'long_description'   => '<div class="wc-gzd-additional-desc">' . _x( 'Enabling this option will display options for the user to deliver to their preferred neighbor during the checkout.', 'dhl', 'woocommerce-germanized' ) . '</div>',
