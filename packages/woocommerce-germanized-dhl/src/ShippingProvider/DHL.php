...
class DHL extends Auto {
	...
	protected function get_general_settings( $for_shipping_method = false ) {
		$settings = array(
			...
			array( 'title' => _x( 'Products and Participation Numbers', 'dhl', 'woocommerce-germanized' ), 'type' => 'title', 'id' => 'dhl_api_options' ),
		);
	...
	protected function get_label_settings( $for_shipping_method = false ) {
		...
		$settings = array(
			array( 'title' => '', 'title_method' => _x( 'Products', 'dhl', 'woocommerce-germanized' ), 'type' => 'title', 'id' => 'shipping_provider_dhl_label_options', 'allow_override' => true ),
		...
		$settings = array_merge( $settings, array(
			...
			array( 'title' => _x( 'Default Services', 'dhl', 'woocommerce-germanized' ), 'allow_override' => true, 'type' => 'title', 'id' => 'dhl_label_default_services_options', 'desc' => sprintf( _x(  'Adjust services to be added to your labels by default. Find out more about these <a href="%s" target="_blank">services</a>.', 'dhl', 'woocommerce-germanized' ), 'https://www.dhl.de/de/geschaeftskunden/paket/leistungen-und-services/services/service-loesungen.html' ) ),
			array(
