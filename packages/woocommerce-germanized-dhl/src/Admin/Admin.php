	...
	public static function output_dp_charge_field( $option ) {
		...
		<tr valign="top">
			...
			<td class="forminp forminp-custom" id="woocommerce_gzd_dhl_im_portokasse_charge_wrapper">
				...
				<p class="description"><?php printf( esc_html_x( 'The minimum amount is %s', 'dhl', 'woocommerce-germanized' ), wc_price( 10, array( 'currency' => 'EUR' ) ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			</td>
		</tr>
		<?php
	}
