<?php
/**
 * Class WC_STC_Email_New_Return_Shipment file.
 *
...
if ( ! class_exists( 'WC_STC_Email_New_Return_Shipment_Request', false ) ) :

	/**
	 * Admin return shipment notification.
	 *
	 * @class    WC_STC_Email_New_Return_Shipment_Request
	 * @version  1.0.0
	 * @package  Vendidero/Shiptastic/Emails
	 * @extends  WC_Email
	 */
	class WC_STC_Email_New_Return_Shipment_Request extends WC_Email {
		...
		public function __construct() {
			...
			add_action( 'woocommerce_shiptastic_new_customer_return_shipment_request', array( $this, 'trigger' ), 10 );
...
return new WC_STC_Email_New_Return_Shipment_Request();
