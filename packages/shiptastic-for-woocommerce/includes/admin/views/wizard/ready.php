...
<div class="wc-shiptastic-wizard-inner-content inner-content-small">
	...
	<div class="wc-shiptastic-wizard-links">
		<a class="button button-primary" href="<?php echo esc_url( \Vendidero\Shiptastic\Admin\Settings::get_settings_url() ); ?>"><?php echo esc_attr_x( 'To the settings', 'shipments-wizard', 'woocommerce-germanized' ); ?></a>
	</div>
</div>
