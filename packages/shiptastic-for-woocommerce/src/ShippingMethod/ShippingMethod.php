	...
	public function init_form_fields() {
		...
		$this->instance_form_fields = array(
			...
			'disable_if_providers_available'           => array(
				'title'    => _x( 'Disable in case available', 'shipments', 'woocommerce-germanized' ),
				'type'     => 'multiselect',
				'class'    => 'wc-enhanced-select',
				'default'  => array(),
				'options'  => $provider_options,
				'desc_tip' => _x( 'You may choose to disable this method in case other shipping providers are available for the current cart.', 'shipments', 'woocommerce-germanized' ),
			),
			...
			'packaging'                                => array(
				'title'   => _x( 'Packaging', 'shipments', 'woocommerce-germanized' ),
				'type'    => 'packaging',
				'default' => array(),
			),
			'cache'                                    => array(
		...
		return apply_filters(
			...
			array(
				...
				'package_subtotal'         => array(
					'label'     => _x( 'Package subtotal (before discounts)', 'shipments', 'woocommerce-germanized' ),
					'fields'    => array(
						'total_from' => array(
							'type'      => 'text',
							'data_type' => 'price',
				...
				'subtotal'                 => array(
					'label'     => _x( 'Cart subtotal (before discounts)', 'shipments', 'woocommerce-germanized' ),
					'fields'    => array(
						'total_from' => array(
							'type'      => 'text',
							'data_type' => 'price',
				...
				<td colspan="7">
					<p class="packaging-info">
						...
						<label class="packaging-info-meta-field" for="<?php echo esc_attr( $packaging_field_key ); ?>_{{ data.packaging }}_single_use_only">
							<?php echo esc_html_x( 'Single use only?', 'shipments', 'woocommerce-germanized' ); ?>
