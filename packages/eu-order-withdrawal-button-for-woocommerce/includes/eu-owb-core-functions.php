...
function eu_owb_find_orders( $args ) {
	...
	// Try to find the order by a custom order number field in case the parsed order id does not match the arg
	if ( ! empty( $order_number_parsed ) && $order_number_parsed !== $order_id_parsed ) {
