...
<p><?php printf( esc_html_x( 'We regret to inform you that your withdrawal request has been rejected.', 'owb', 'woocommerce-germanized' ), esc_html( $order->get_order_number() ) ); ?></p>
