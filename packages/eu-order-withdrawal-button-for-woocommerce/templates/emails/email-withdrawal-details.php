...
<?php if ( $show_deleted_original && ( $original_order_id = eu_owb_order_withdrawal_request_get_original_order_id( $withdrawal ) ) ) : ?>
	<p><?php echo wp_kses_post( sprintf( _x( 'As you requested, we have deleted your original withdrawal request to %1$s.', 'owb', 'woocommerce-germanized' ), esc_html( $original_order_id ) ) ); ?></p>
<?php endif; ?>
