    ...
    var $table = $('.wc-gzd-legal-checkboxes'),
      ...
      LegalCheckboxView = Backbone.View.extend({
        ...
        initialize: function () {
          ...
          $(document.body).on('click', '.wc-gzd-legal-checkbox-add', {
            view: this
          }, this.onAddNewRow);
        },
        block: function () {
        ...
        render: function () {
          ...
          if (_.size(checkboxes)) {
            // Sort zones
            checkboxes = _(checkboxes).chain().sortBy(function (checkbox) {
              return parseInt(checkbox.priority, 10);
            }).value();
        ...
        initRow: function (rowData) {
          ...
          $tr.find('.wc-gzd-legal-checkbox-delete').on('click', {
            view: this
          }, this.onDeleteRow);
        },
        initRows: function () {
...
((window.germanized = window.germanized || {})["static"] = window.germanized["static"] || {})["admin-legal-checkboxes"] = __webpack_exports__;
/******/ })()
;